...
//  General option
//------------------------------------------------------
if ((of_get_option('header_background') != '') || (of_get_option('header_color') != '') || (of_get_option('body_background') != '') || (of_get_option('custom_css') != '')) {
...
// show items number for mini-cart on header
add_filter('woocommerce_add_to_cart_fragments', 'woocommerce_header_add_to_cart_fragment');
function woocommerce_header_add_to_cart_fragment( $fragments ) {
    global $woocommerce;
    ob_start();
?>
    <i id="shopping-amount" class="ci-count"><?php echo $woocommerce->cart->cart_contents_count ?></i>
<?php
    $fragments['i.ci-count'] = ob_get_clean();
    return $fragments;
}
