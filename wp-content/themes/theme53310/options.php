...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '17px', 'lineheight' => '27px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2c2c2c'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '58px', 'lineheight' => '53px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2c2c2c'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '45px', 'lineheight' => '53px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#2c2c2c'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '35px', 'lineheight' => '39px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2c2c2c'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2c2c2c'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2c2c2c'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '72px', 'lineheight' => '72px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '24px', 'lineheight' => '24px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '15px', 'lineheight' => '23px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#888888'));
