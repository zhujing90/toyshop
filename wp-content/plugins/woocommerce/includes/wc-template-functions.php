...
if ( ! function_exists( 'woocommerce_template_loop_product_title' ) ) {
	...
	function woocommerce_template_loop_product_title() {
	    $title = get_the_title();
		echo '<h2 class="woocommerce-loop-product__title">' . substr($title, 0, 24) . '</h2>';
	}
}
...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_button_view_cart' ) ) {
	...
	function woocommerce_widget_shopping_cart_button_view_cart() {
		...
		echo '<a href="' . esc_url( wc_get_cart_url() ) . '" class="button wc-forward woo-widget-viewcart">' . esc_html__( 'View cart', 'woocommerce' ) . '</a>';
	}
}
...
if ( ! function_exists( 'woocommerce_widget_shopping_cart_proceed_to_checkout' ) ) {
	...
	function woocommerce_widget_shopping_cart_proceed_to_checkout() {
		echo '<a href="' . esc_url( wc_get_checkout_url() ) . '" class="button checkout wc-forward woo-widget-checkout">' . esc_html__( 'Checkout', 'woocommerce' ) . '</a>';
	}
}
